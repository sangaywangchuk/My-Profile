...
export default function Blog(props: { isVisible: boolean }) {
	...
	return (
		<Box bg={useColorModeValue("cyan.100", "gray.700")} py={150}>
			<Container maxW={"5xl"} py={12} as={Stack} spacing={12}>
				<Stack spacing={0} align={"center"}>
					...
					<Text className={props.isVisible? 'text-focus-in': 'fade-out'}>We have been working with clients around the world</Text>
				</Stack>
				<Stack
